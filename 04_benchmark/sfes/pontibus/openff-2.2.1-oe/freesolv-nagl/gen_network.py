...
def run(ligands: pathlib.Path, fsolv: pathlib.Path):
    ...
    smcs = [
        ...
        if mol.GetProp("SMILES") in fsolv_mols
    ]
...
if __name__ == "__main__":
    ligands = pathlib.Path("../all_molecules_openff-gnn-am1bcc-0.1.0-rc.3.pt_openff-nagl.sdf")
    fsolv = pathlib.Path("../sage-fsolv-test-v1.csv")
    run(ligands, fsolv)
