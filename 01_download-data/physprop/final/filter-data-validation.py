...
@click.option(
    "--input-file",
    "-i",
    default="../intermediate/output/initial-filtered.csv",
    help="The JSON file containing existing parsed ThermoML data",
)
@click.option(
    "--exclude-file",
    "-x",
    default="exclude-molecules.smi",
...
def main(
    input_file: str = "../intermediate/output/initial-filtered.csv",
    training_file: str = "output/training-set.json",
    exclude_file: str = "exclude-molecules.smi",
    ...
    if renumber:
        ...
        for i, prop in enumerate(ds.properties, 1):
            ...
            prop.id = new_id
        print("Renumbering property IDs")
