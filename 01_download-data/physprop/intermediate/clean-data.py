...
def main(
    ...
    print(f"Loaded {input_file} with {len(input_df)} rows")

    # filter out all data points from 10.1016/j.jct.2007.12.002
    # under 1 MPa
    input_df = input_df[input_df["Source"] != "10.1016/j.jct.2007.12.002"]
    print(f"Filtered out 10.1016/j.jct.2007.12.002, now {len(input_df)} rows")
    ...
    print(f"Filtered out 10.1016/j.tca.2006.02.028, now {len(input_df)} rows")
